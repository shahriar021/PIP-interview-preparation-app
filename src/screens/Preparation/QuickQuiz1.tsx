...
import { useGetQuizInfoQuery } from 'src/redux/features/quiz/quizApi'
...
const QuickQuiz1 = () => {
    ...
    // ── API ──────────────────────────────────────────────────────────────────
    const { data: getQuizInfo, isLoading, error } = useGetQuizInfoQuery(id)
    console.log(getQuizInfo?.data?.result_id,"getQuizInfo")
    const resId=getQuizInfo?.data?.result_id
    const questions: Question[] = getQuizInfo?.data?.questions  ?? []
