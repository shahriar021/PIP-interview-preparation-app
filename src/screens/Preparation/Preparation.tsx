...
const Preparation = () => {
  ...
  return (
    <View className='flex-1 bg-white p-3'>
      <Text className='font-robotoRegular text-black text-md'>Choose how you’d like to practice today. Take quizzes to test your knowledge or join a mock interview to build confidence.</Text>
